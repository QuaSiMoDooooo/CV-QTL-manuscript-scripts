...
# -------------
# FileName     : 02_cis_QTL_overlap_batch.R
# Author       : Tian Wu fabien012390wt@163.com
# Modified By  : Tian Wu
# -------------
# Description  : Batch mediation analysis for cis-QTL overlap data
# -------------
...
data_dir = "/home/wtian/project/HZAU_cohort_meth/wdy_assist_rerun/09_mediation_analysis/02_format/01_cis_QTL_overlap"
